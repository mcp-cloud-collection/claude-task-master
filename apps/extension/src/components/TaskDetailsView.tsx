                ...
                <div className="space-y-3">
                  ...
                  {isAddingSubtask && (
                    <div className="bg-widget-background rounded-lg p-4 border border-widget-border">
                      ...
                      <div className="space-y-3">
                        <div>
                          <Label htmlFor="subtask-title" className="block text-sm text-vscode-foreground/80 mb-1">
                            Title*
                          </Label>
                          <input
                            id="subtask-title"
                        ...
                        <div>
                          <Label htmlFor="subtask-description" className="block text-sm text-vscode-foreground/80 mb-1">
